...
summary_scores_subjects <- data.frame(matrix(0, ncol = 22, nrow = 11))
names(summary_scores_subjects) <- c('Number of students participated',
                                    'Minimum score',
                                    '25th percentile',
                                    'Median',
                                    'Mean score',
...
summary_scores_combinations <- data.frame(matrix(0, ncol = 22, nrow = 11))
names(summary_scores_subjects) <- c('Number of students participated',
                                    'Minimum score',
                                    '25th percentile',
                                    'Median',
